...
// =============================================================================
//
//	  	Code to swap between Little and Big Endian byte order
//	  	This code was found in a library on the internet 
//		http://www.gdargaud.net/Hack/SourceCode.html
//
// =============================================================================
// PKS: Modifictions to include additional data types
// =============================================================================
