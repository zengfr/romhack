;TITLE NASM  8086 Code Template (nasm for dos com file)
...
string_fun1: RESB  100 
	    db '$'
string_fun1_result: RESB 100  
	    db '$'
string_fun2: RESB 100  
	    db '$'
string_fun2_result: RESB 10 
	    db '$'	    
string_fun3 : RESB 100   
	    db '$'  
string_fun3_hex  : RESB 100  
	        db '$'
string_fun3_count  : RESB 10  
	        db '$'
string_fun3_result  : RESB 100          
	           db '$'
string_fun3_hexcopy  : RESB 100         
	            db '$'	
stack :
 align 0x4
 resb 100h              
